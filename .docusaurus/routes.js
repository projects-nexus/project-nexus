...
export default [
  {
    ...
    component: ComponentCreator('/project-nexus/markdown-page','a8d'),
    exact: true
  },
  {
    path: '/project-nexus/docs',
    component: ComponentCreator('/project-nexus/docs','ad4'),
    routes: [
      {
  ...
  {
    path: '/project-nexus/',
    component: ComponentCreator('/project-nexus/','3c8'),
    exact: true
  },
  {
    path: '*',
